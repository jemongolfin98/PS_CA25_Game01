...
public class GM_V02_W01 : MonoBehaviour
{
    ...
    private string wordToGuess = "resume";
    ...
    public void PlayNextLevel()
    {
        ...
        else if (randomNumber == 6 && word06Completed == false)
        {
            SceneManager.LoadScene("V02_Word06");
        }
        else if (randomNumber == 7 && word07Completed == false)
        {
            SceneManager.LoadScene("V02_Word07");
        }
        else if (randomNumber == 8 && word08Completed == false)
        {
            SceneManager.LoadScene("V02_Word08");
        }
        else if (randomNumber == 9 && word09Completed == false)
        {
            SceneManager.LoadScene("V02_Word09");
        }
        else if (randomNumber == 10 && word10Completed == false)
        {
